function [F, M] = controller2(t, s, s_des, error)
...
%params
Kp_i = [10,10,15]*5;   %2           3  fast
Kd_i = [2,2,8]*5;  %0.6 soft   1.0
Ki_i = [10,10,1];
Kp_phi = 20*5; %20
Kd_phi = 6*5;  %4 fast
Kp_theta = 20*5;
...
r2c = zeros(3,1);
while(i<4)
	r2c(i) = Kp_i(i) * (s_des(i) - sp(i)) + Kd_i(i) * (s_des(i+3) - sp(i+3)) + Ki_i(i) * error(i);
	i = i + 1;
end
F = m * (g + r2c(3));
